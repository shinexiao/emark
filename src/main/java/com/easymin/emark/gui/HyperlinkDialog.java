...
public class HyperlinkDialog extends Dialog {
	...
	public HyperlinkDialog(JFrame owner,ButtonActionListener buttonActionListener) {
		super(owner,true);
	...
	private void initComponents() {
		this.setTitle(bundle.getString("hyperlinkDialog.title"));
        ...
        titleLabel.setText(bundle.getString("hyperlinkDialog.Labeltitle"));

        okbutton.setText(bundle.getString("hyperlinkDialog.ok"));
        cancelbutton.setText(bundle.getString("hyperlinkDialog.cancel"));
